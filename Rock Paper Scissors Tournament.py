...
def game_header(names_list):
    ...
    for name in names_list:
        ...
        if amount_space % 2 == 1:
            print(space * int((amount_space - 1) / 2) + name
                  + space * int((amount_space + 1) / 2), end="")
...
def phase_1_of_game(names_list):
    ...
    while names_list.count("Out") < len(names_list) - 2:
        ...
        for name in names_list:
            ...
            print_phase_1(outcome_for_name, name)
...
def print_phase_1(outcome_for_name, name):
    """
         prints phase 1 of the game while keeping track of each person's move: rps or "X"

           Parameters:
             name: each name for the for loop
             outcome_for_name: the list for each outcome for the round of the game

           """
    # Start of statements for the print_phase_1 function
    if name == "Out":
        print("    X     ", end="")
        choice = "X"
...
def phase_2_of_game(names_list):
    ...
    while winner == "":
        ...
        for name in names_list:
            print_phase_2(outcome_for_name, name)
...
def print_phase_2(outcome_for_name, name):
    """
      prints phase 2 of the game while keeping track of each person's move: rps or "X"
        ...
        """
    # Start of statements for the print_phase_2 function
    if name == "Out":
        print("    X     ", end="")
        choice = "X"
...
def return_winner(outcome_for_name, names_list):
    """
      returns the winner if phase2 has completed. else, continues phase 2
